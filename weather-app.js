...
function showWeather(lat, long) {
  var url = `https://api.darksky.net/forecast/a7a4f3bcc32a04dafdae2f70b380812f/${lat},${long}` + `?format=jsonp&callback=displayWeather`;
...
function displayWeather(object) {
  ...
  temperature.innerHTML = farenheidToCelsius(object.currently.temperature) + " C" + " / " + object.currently.temperature + " F";
